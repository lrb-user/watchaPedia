...
const MobileLoginLayout:React.FC = () => { 
    return(
        <>
            <div className="w-full h-screen relative bg-bgLogin bg-no-repeat text-white">
                <div className="absolute top-0 left-0 w-full h-full bg-black opacity-70">
                    <div id="header" className="w-full relative h-16 px-6">
                        <Link to="mobileMain" className="w-32 h-7 absolute top-1/2 -translate-y-1/2">
                    ...
                    <Outlet />
                    <div id="footer" className="grid gap-y-1 text-white text-center text-xs">
                        <p className="font-bold">
                            주식회사 왓챠 / 대표 홍길동 / 사업자번호 000-0000-0000
                        </p>
                        <p> 
                            개인정보 처리 방침 / 청소년 보호정책
                        </p>
