...
const ThisMonthBestContentMovie:React.FC =() => {
    return(
        <>
            <div id="movie" className="flex justify-center gap-5">
                {movieData.map((data) => (
                    <Link to="/movieContentPage" key={data.id} className="grid gap-5">
                        <div className="">
...
export default ThisMonthBestContentMovie;