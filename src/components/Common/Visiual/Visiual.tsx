    ...
    return(
        <>
            <div className="relative">
                <div className="w-full h-[34rem] bg-black grid overflow-hidden">
                    <div className="bg-movieBg1 bg-no-repeat bg-center bg-cover duration-1000 hover:scale-125"></div>
                </div>
                <div className="absolute grid gap-4 bottom-14 left-14 text-white">
                    <h2 className="text-4xl font-bold">시민덕희</h2>
                    <p className="text-sm">시민덕희</p>
                    <p className="text-sm">2021 · 드라마 · 한국</p>
                    <p className="text-sm">1시간 53분 · 15분</p>
                    <p className="text-sm">예매 순위 2위(9.3%) · 개봉 7일째 · 누적관객 55.1만명</p>
                </div>
            </div>
        </>
    )
