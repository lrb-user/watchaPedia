...
const bannerData = [
    ...
    {id:4, src:'/watchaPedia/assets/images/mainBanner4.jpg', movieNameSrc:'/watchaPedia/assets/images/mainBanner4Title.png', desc1:'수많은 곡들로 대한민국 가요계를 대표하며 최정상의 자리를 지켜온 그룹 샤이니', desc2:'최고의 퍼포먼스로 돌아온 그들의 여섯 번째 콘서트'},
]
